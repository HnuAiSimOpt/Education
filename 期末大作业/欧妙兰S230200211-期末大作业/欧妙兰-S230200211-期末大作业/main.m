%%purpose:起重机平面桁架结构的位移求解和内力求解
%%姓名和学号：欧妙兰 S230200211
%%题目条件：水平杆和竖直杆材料AL，截面积A1=2cm^2,E1=70GPa;斜肋杆材料为钢，A2=3cm^2,E2=210GPa;
% 水平杆长l1=1m，竖直杆长l2=0.5m；外载荷施加在节点502处y负方向；节点1、2处固定
