...
%--------------------------------------------
%导入网格节点信息
x0 = load('C:\Users\alein\Desktop\S200200239_FEM\code\da_mesh\txt\x0.txt');
%导入网格节点与单元的连接信息
nodes = load('C:\Users\alein\Desktop\S200200239_FEM\code\da_mesh\txt\nodes.txt');
...
%--------------------------------------------------------------------------
%导入集中载荷所施加的节点编号信息
f_n = load('C:\Users\alein\Desktop\S200200239_FEM\code\da_mesh\txt\fload_number.txt');
...
bcdof=[];
bcval=[];        
bc1 = load('C:\Users\alein\Desktop\S200200239_FEM\code\da_mesh\txt\bc1_number.txt');
%--------------------------------------
...
%-------------------------------------------------------------
fid_out=fopen('C:\Users\alein\Desktop\S200200239_FEM\code\da_mesh\result_beamQ4_1.plt','w');
