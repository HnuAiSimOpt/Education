...
for i=1:lx
    ...
    elseif i==lx/2+1
            for j=1:ly/2
                nodes=[nodes; (ly+1)*(i-1)+j (ly/2+1)*(i-lx/2-1)+j+2145  (ly+1)*(i-1)+j+1;];
                nodes=[nodes; (ly/2+1)*(i-lx/2-1)+j+2145 (ly/2+1)*(i-lx/2-1)+j+2146 (ly+1)*(i-1)+j+1;];
            end
    else
        for j=1:ly/2
            nodes=[nodes; (ly/2+1)*(i-lx/2-2)+j+2145 (ly/2+1)*(i-lx/2-1)+j+2145 (ly/2+1)*(i-lx/2-2)+j+2146;];
            nodes=[nodes; (ly/2+1)*(i-lx/2-1)+j+2145 (ly/2+1)*(i-lx/2-1)+j+2146 (ly/2+1)*(i-lx/2-2)+j+2146;];
        end
    end
end
bcdof=[];
